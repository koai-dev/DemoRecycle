package com.idance.hocnhayonline.singleUnit.adapter
...
class SingleUnitAdapter @Inject constructor() : ListAdapter<Movie, SingleUnitAdapter.SingleVH>(MovieComparator()) {
